            ...
            <div class="container-fluid">
                <form action="{{ route('plantillas.update', $plantilla) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div id="editor">{{ $plantilla->contenido }}</div>
                        <textarea name="contenido" id="code-view" style="display:none;"></textarea>
                    </div>
                ...
                <script>
                    var editor = new FroalaEditor('#editor', {
                        toolbarButtons: [
                            'bold', 'italic', 'underline', 'insertImage', 'insertTable', 'insertLink', 'html', 'undo', 'redo'
                        ],
                        events: {
                    ...
                    function updateCodeView() {
                        const html = editor.html.get(); // Obtiene el contenido HTML
                        document.getElementById('code-view').value = html; // Asigna el contenido al textarea oculto
                    }
                
                    // Inicializar el textarea con el contenido existente
                    document.getElementById('code-view').value = `{{ $plantilla->contenido }}`;
                </script>
